...
#
# Generated by export_simulation on Wed Mar 22 11:55:30 +0000 2023
#
################################################################################
...
'-reset_run' switch to the './tb_dataGenConsume.sh' script.

./tb_dataGenConsume.sh -reset_run
...
./tb_dataGenConsume.sh -noclean_files

For more information on the script, please type './tb_dataGenConsume.sh -help'.
